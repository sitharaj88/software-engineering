...
<CardGrid>
  ...
  <Card title="System Design" icon="setting">
    ...
    **Case Studies**: URL Shortener, Chat App, News Feed
    ...
    [Explore System Design →](/system-design/)
  </Card>
  ...
  <Card title="Interview Preparation" icon="rocket">
    ...
    **Behavioral**: STAR method, top 20 questions, leadership principles
    ...
    [Start Interview Prep →](/interview-prep/)
  </Card>
</CardGrid>
...
<CardGrid stagger>
  <Card title="Sorting Visualizer" icon="seti:video">
    ...
    [Try Sorting Visualizer →](/dsa/sorting/)
  </Card>
  ...
  <Card title="Algorithm Race" icon="rocket">
    ...
    [Try Algorithm Race →](/dsa/sorting/)
  </Card>
</CardGrid>
...
<CardGrid stagger>
  <Card title="Foundations Track" icon="open-book">
    ...
    **Prerequisites**: Basic programming knowledge
    ...
    [Begin Foundations Track →](/getting-started/learning-paths/)
  </Card>
  <Card title="Interview Preparation" icon="rocket">
    ...
    **Prerequisites**: Familiarity with basic data structures
    ...
    [Begin Interview Prep →](/interview-prep/)
  </Card>
  <Card title="System Design Track" icon="setting">
    ...
    **Prerequisites**: Basic web development knowledge
    ...
    [Begin System Design →](/system-design/)
  </Card>
  <Card title="Advanced Track" icon="star">
    ...
    **Prerequisites**: Solid DSA fundamentals
    ...
    [Begin Advanced Track →](/getting-started/learning-paths/)
  </Card>
</CardGrid>
...
<CardGrid>
  <LinkCard
    ...
    href="/dsa/#complexity-cheatsheet"
