...
- [Beginner Path](/getting-started/learning-paths/#beginner) - Start from scratch
- [Interview Prep Path](/getting-started/learning-paths/#interview) - Fast-track for interviews
- [Advanced Path](/getting-started/learning-paths/#advanced) - Deep expertise
...
<CardGrid>
  <LinkCard title="Big O Notation" href="/dsa/fundamentals/big-o-notation/" description="Start with the foundation - learn to analyze algorithm efficiency" />
  <LinkCard title="Arrays" href="/dsa/arrays/" description="The most fundamental data structure" />
  <LinkCard title="Learning Paths" href="/getting-started/learning-paths/" description="Choose a structured learning journey" />
</CardGrid>
