...
- [ ] [Big O Notation](/dsa/fundamentals/big-o-notation/) - Understand algorithm efficiency
- [ ] [Time Complexity](/dsa/fundamentals/time-complexity/) - Analyze execution time
- [ ] [Space Complexity](/dsa/fundamentals/space-complexity/) - Analyze memory usage

### Week 3-4: Arrays & Strings
- [ ] [Arrays Introduction](/dsa/arrays/) - Basic operations
- [ ] [Two Pointers](/dsa/arrays/two-pointers/) - Essential technique
- [ ] [Sliding Window](/dsa/arrays/sliding-window/) - Subarray problems
- [ ] [Strings](/dsa/strings/) - Text manipulation

### Week 5-6: Linear Data Structures
- [ ] [Linked Lists](/dsa/linked-lists/) - Node-based storage
- [ ] [Stacks](/dsa/stacks/) - LIFO operations
- [ ] [Queues](/dsa/queues/) - FIFO operations
- [ ] [Hash Tables](/dsa/hash-tables/) - Key-value storage

### Week 7-8: Trees & Basic Algorithms
- [ ] [Trees Introduction](/dsa/trees/) - Hierarchical data
- [ ] [Binary Search Trees](/dsa/trees/binary-search-trees/)
- [ ] [Sorting Algorithms](/dsa/sorting/) - Basic sorts
- [ ] [Binary Search](/dsa/searching/binary-search/)

### Week 9-10: Recursion & Graphs
- [ ] [Recursion](/dsa/recursion/) - Recursive thinking
- [ ] [Graphs Introduction](/dsa/graphs/) - Networks and connections
- [ ] [BFS & DFS](/dsa/graphs/bfs-dfs/) - Graph traversal
...
<LinkCard
  ...
  href="/dsa/fundamentals/big-o-notation/"
