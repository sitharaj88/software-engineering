...
<CardGrid>
  <Card title="Coding Interviews" icon="seti:python">
    ...
    [Coding Interview Guide -->](/software-engineering/interview-prep/coding-interviews/)
  </Card>
  <Card title="Behavioral Interviews" icon="comment-alt">
    ...
    [Behavioral Interview Guide -->](/software-engineering/interview-prep/behavioral/)
  </Card>
  <Card title="System Design" icon="setting">
    ...
    [System Design Interview Guide -->](/software-engineering/system-design/)
  </Card>
  <Card title="Problem Bank" icon="list-format">
    ...
    [View Problem Bank -->](/software-engineering/interview-prep/problem-bank/)
  </Card>
</CardGrid>
