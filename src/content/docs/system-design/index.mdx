...
<CardGrid>
  <Card title="Fundamentals" icon="open-book">
    ...
    [Explore Fundamentals →](/software-engineering/system-design/fundamentals/)
  </Card>
  <Card title="Databases" icon="list-format">
    ...
    [Explore Databases →](/software-engineering/system-design/databases/)
  </Card>
  <Card title="Scalability" icon="rocket">
    ...
    [Explore Scalability →](/software-engineering/system-design/scalability/)
  </Card>
  <Card title="Case Studies" icon="puzzle">
    ...
    [Explore Case Studies →](/software-engineering/system-design/case-studies/)
  </Card>
  <Card title="Caching & CDNs" icon="star">
    ...
    [Covered in Scalability →](/software-engineering/system-design/scalability/)
  </Card>
...
<CardGrid stagger>
  <Card title="Week 1-2: Fundamentals" icon="open-book">
    ...
    [Begin with Fundamentals →](/software-engineering/system-design/fundamentals/)
  </Card>
  <Card title="Week 3-4: Storage & Data" icon="list-format">
    ...
    [Study Databases →](/software-engineering/system-design/databases/)
  </Card>
  <Card title="Week 5-6: Scaling Patterns" icon="rocket">
    ...
    [Learn Scalability →](/software-engineering/system-design/scalability/)
  </Card>
  <Card title="Week 7-8: Practice" icon="puzzle">
    ...
    [Practice Case Studies →](/software-engineering/system-design/case-studies/)
  </Card>
</CardGrid>
