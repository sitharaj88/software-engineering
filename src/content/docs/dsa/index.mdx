...
- [Big O Notation](/dsa/fundamentals/big-o-notation/) - Analyze algorithm efficiency
- [Time Complexity](/dsa/fundamentals/time-complexity/) - Measure execution time
- [Space Complexity](/dsa/fundamentals/space-complexity/) - Measure memory usage

### Phase 2: Linear Data Structures (Week 3-5)
- [Arrays](/dsa/arrays/) - Sequential storage, two pointers, sliding window
- [Strings](/dsa/strings/) - Text manipulation, pattern matching
- [Linked Lists](/dsa/linked-lists/) - Dynamic node-based storage
- [Stacks](/dsa/stacks/) - LIFO operations, monotonic stacks
- [Queues](/dsa/queues/) - FIFO operations, priority queues

### Phase 3: Non-Linear Data Structures (Week 6-8)
- [Hash Tables](/dsa/hash-tables/) - Key-value storage, O(1) lookups
- [Trees](/dsa/trees/) - Hierarchical data, BST, traversals
- [Heaps](/dsa/heaps/) - Priority operations, top-k problems
- [Graphs](/dsa/graphs/) - Networks, paths, connectivity

### Phase 4: Algorithms (Week 9-12)
- [Sorting](/dsa/sorting/) - Bubble, merge, quick, heap sort
- [Searching](/dsa/searching/binary-search/) - Binary search and variations
- [Recursion](/dsa/recursion/) - Divide and conquer
- [Backtracking](/dsa/backtracking/) - Exhaustive search with pruning
- [Dynamic Programming](/dsa/dynamic-programming/) - Optimal substructure
- [Greedy](/dsa/greedy/) - Local optimal choices
